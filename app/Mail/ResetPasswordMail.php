...
class ResetPasswordMail extends Mailable
{
    ...
    {
        return $this
            ->subject('💍 Le Rêve — Code de réinitialisation')
            ->html("
                <div style='font-family:Georgia,serif;max-width:500px;margin:0 auto;padding:40px 20px;'>
                    <h1 style='color:#7c3aed;font-size:1.5rem;margin-bottom:8px;'>💍 Le Rêve</h1>
                    ...
                    <p style='color:#94a3b8;font-size:0.75rem;text-align:center;'>Le Rêve — Planification de mariage</p>
                </div>
            ");
    }
}
